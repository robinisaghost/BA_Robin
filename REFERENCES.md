...
[1] Hochreiter, S., & Schmidhuber, J. (1997). Long short-term memory.
    *Neural Computation*, 9(8), 1735–1780.
    ...
    → Used in: `src/ba_baseline/models/lstm.py`, `scripts/train_lstm_60min.py`
...
[2] Nie, Y., Nguyen, N. H., Sinthong, P., & Kalagnanam, J. (2023). A time
    ...
    *Proceedings of the Eleventh International Conference on Learning
    ...
    → Used in: `src/ba_baseline/models/patchtst.py`, `scripts/train_patchtst_60min.py`
...
[4] van den Hoek, R. (2026). Mitigating Time-Shift Errors in CGM-based
...
[5] Hüni, F. (2023). Predicting events of hypoglycemia: A comparison of long
...
[6] Garcia-Tirado, J., Colmegna, P., Villard, O., Diaz, J. L.,
...
[7] Pattern Recognition Group, University of Bern. Glucose Prediction
