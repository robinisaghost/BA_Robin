...
def main():
    ...
    example_pids_60 = sorted(traces_60.keys())[:3]
    np.savez(
        "reports/results/lstm_60min_traces_examples.npz",
        **{f"{pid}_true": traces_60[pid][0] for pid in example_pids_60},
        **{f"{pid}_pred": traces_60[pid][1] for pid in example_pids_60},
    )
