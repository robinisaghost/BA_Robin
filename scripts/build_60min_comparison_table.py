...
print()
print("Summary:")
print(f"LSTM     mean RMSE: {pivot['lstm_rmse'].mean():.3f}  mean MAE: {pivot['lstm_mae'].mean():.3f}")
print(f"PatchTST mean RMSE: {pivot['patchtst_rmse'].mean():.3f}  mean MAE: {pivot['patchtst_mae'].mean():.3f}")
print()
