...
\title{Hypoglykämie-Erkennung Explorationstudie}
...
\begin{table}[h]
\centering
\caption{Vergleich aller Modellvarianten zur Hypoglykämie-Erkennung (Cohortmean, 36 Patienten, Schwellenwert 70~mg/dL).
}
